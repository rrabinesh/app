...
class SmartyPage:
    ...
    def __init__(self, request: Request, template_dir: Path, static_dir: Path):
    ...
    def display(self, template_name: str, **context):
    ...
    def include_js(self, filename: str) -> str:
        src = self.static_dir / "js" / filename
        return f"<script src='{src}'></script>"

    def include_css(self, filename: str) -> str:
        href = self.static_dir / "css" / filename
