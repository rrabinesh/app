...
class IPermissibleResource:
    def GetResourceId(self) -> int:
        pass

class IResource(IPermissibleResource):
    def GetId(self) -> int:
        pass
    ...
    def GetAdminGroupId(self) -> int:
        pass

    def GetScheduleId(self) -> int:
        pass

    def GetScheduleAdminGroupId(self) -> int:
        pass

    def GetStatusId(self) -> int:
        pass

class IBookableResource(IResource):
    def GetMinimumLength(self) -> dict:
        pass

    def GetRequiresApproval(self) -> bool:
        pass

    def IsCheckInEnabled(self) -> bool:
        pass

    def IsAutoReleased(self) -> bool:
        pass

    def GetAutoReleaseMinutes(self) -> Optional[int]:
        pass

    def GetResourceTypeId(self) -> int:
        pass

    def GetColor(self) -> Optional[str]:
        pass

    def GetTextColor(self) -> Optional[str]:
        pass
...
class BookableResourceBuilder:
    def __init__(self):
        ...
        self.allowMultiday = False
        self.maxParticipants = None
        self.minNoticeAdd = None
        self.minNoticeUpdate = None
        self.minNoticeDelete = None
        self.maxNotice = None
        self.description = None
        self.scheduleId = None
        self.adminGroupId = None
        self.imageName = None
        self.status = None
        self.sortOrder = None
        self.resourceTypeId = None
        self.publicId = None
        ...
        self.autoReleaseMinutes = None
        self.allowDisplay = False
        self.peakCredits = None
        self.offPeakCredits = None
    ...
    def build(self):
        # Build and return the BookableResource instance
        pass

    def id(self, id: int) -> 'BookableResourceBuilder':
        self.id = id
        return self

    def name(self, name: str) -> 'BookableResourceBuilder':
        self.name = name
        return self

    def location(self, location: str) -> 'BookableResourceBuilder':
        self.location = location
        return self

    # Other setter methods follow...

class BookableResource(IBookableResource):
    def __init__(self, resource_id, name, location, contact, notes, min_length, max_length,
                 auto_assign, requires_approval, allow_multiday, max_participants,
                 min_notice_add, max_notice, description=None, schedule_id=None, admin_group_id=None,
                 min_notice_update=None, min_notice_delete=None):
        ...
        self._autoAssign = auto_assign
        self._clearAllPermissions = False
        self._autoAssignToggledOn = False
        self._requiresApproval = requires_approval
        self._allowMultiday = allow_multiday
        self._maxParticipants = max_participants
        self._minNoticeAdd = min_notice_add
        self._minNoticeUpdate = min_notice_update
        self._minNoticeDelete = min_notice_delete
        self._maxNotice = max_notice
        self._bufferTime = None
        self._scheduleId = schedule_id
        self._imageName = None
        self._imageNames = []
        self._statusId = ResourceStatus.AVAILABLE
        self._statusReasonId = None
        self._adminGroupId = admin_group_id
        self._isCalendarSubscriptionAllowed = False
        self._isDisplayAllowed = False
        self._publicId = None
        self._scheduleAdminGroupId = None
        self._sortOrder = None
        self._resourceTypeId = None
        self._resourceGroupIds = []
        self._enableCheckIn = False
        self._autoReleaseMinutes = None
        self._color = None
        self._textColor = None
        self._creditsPerSlot = None
        self._peakCreditsPerSlot = None
        self._maxConcurrentReservations = 1
...
class BookableResource(BaseModel):
    ...
    resource_group_ids: Optional[List[int]]
    image_name: Optional[str]
    image_names: Optional[List[str]]
    max_length: Optional[int]
    auto_assign: Optional[bool]
    clear_all_permissions: Optional[int]
    requires_approval: Optional[bool]
    allow_multiday: Optional[bool]
    max_participants: Optional[int]
    min_notice_add: Optional[int]
    min_notice_update: Optional[int]
    min_notice_delete: Optional[int]
    max_notice: Optional[int]
    schedule_id: Optional[int]
    admin_group_id: Optional[int]
    status_id: Optional[int]
    status_reason_id: Optional[int]
    is_calendar_subscription_allowed: Optional[bool]
    is_display_enabled: Optional[bool]
    public_id: Optional[str]
    enable_check_in: Optional[bool]
    auto_release_minutes: Optional[int]
    attribute_values: Optional[List[dict]]
    added_attribute_values: Optional[List[dict]]
    removed_attribute_values: Optional[List[dict]]
    added_attributes: Optional[List[dict]]
    removed_attributes: Optional[List[dict]]
    credits_per_slot: Optional[int]
    peak_credits_per_slot: Optional[int]
    max_concurrent_reservations: Optional[int]
    color: Optional[str]
...
@app.post("/bookable_resource/")
async def create_bookable_resource(resource: BookableResource):
    # Perform necessary actions to create the bookable resource
    # (e.g., store in a database)
    return {"message": "Bookable resource created successfully."}

@app.get("/bookable_resource/{resource_id}")
async def get_bookable_resource(resource_id: int):
    # Fetch the bookable resource with the given resource_id
    # (e.g., retrieve from a database)
    return {"resource_id": resource_id, "message": "Bookable resource retrieved successfully."}

@app.put("/bookable_resource/{resource_id}")
async def update_bookable_resource(resource_id: int, resource: BookableResource):
    # Update the bookable resource with the given resource_id using the provided data
    # (e.g., update in a database)
    return {"resource_id": resource_id, "message": "Bookable resource updated successfully."}

@app.delete("/bookable_resource/{resource_id}")
async def delete_bookable_resource(resource_id: int):
    # Delete the bookable resource with the given resource_id
    # (e.g., remove from a database)
    return {"resource_id": resource_id, "message": "Bookable resource deleted successfully."}

# Additional endpoints can be added based on the specific use case and requirements.
