...
class ReservationUserLevel:
    # Add the values of ReservationUserLevel here
    pass
class ReservationStatus:
    # Add the values of ReservationStatus here
    pass
# Other classes and constants need to be defined as well, similar to the PHP code

class ReservationView:
    # Define the ReservationView class with its properties here
    pass
# Define your FastAPI endpoints here
@app.get("/reservation/{reference_number}")
async def get_reservation_for_editing(reference_number: str):
    # Implement the logic to get the reservation for editing and return the ReservationView object
    # You can use a database or any other data source to retrieve the reservation data
    # You need to populate the ReservationView object based on the retrieved data
    pass
@app.get("/reservations/")
async def get_reservations(start_date: str, end_date: str, user_ids: str = "ALL_USERS",
                           user_level: str = "OWNER", schedule_ids: str = "ALL_SCHEDULES",
                           resource_ids: str = "ALL_RESOURCES", consolidate: bool = False,
                           participant_ids: str = "ALL_USERS"):
    # Implement the logic to get reservations based on the provided parameters and return a list of ReservationItemView objects
    # You can use a database or any other data source to retrieve the reservation data
    # You need to populate the ReservationItemView objects based on the retrieved data
    pass
@app.get("/accessory-reservations/")
async def get_accessory_reservations(start_date: str, end_date: str, accessory_name: str):
    # Implement the logic to get accessory reservations based on the provided parameters and return a list of ReservationItemView objects
    # You can use a database or any other data source to retrieve the reservation data
    # You need to populate the ReservationItemView objects based on the retrieved data
    pass
