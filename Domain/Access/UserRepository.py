...
#     {
#         $reader = ServiceLocator::GetDatabase()->Query($command);f bf
...
class UserRepository:
    ...
    def get_by_id(self, user_id: int) -> Optional[schemas.User]:
    ...
    def update(self, user: schemas.UserUpdate) -> models.User:
        db_user = db_session.query(models.User).get(user.id)
