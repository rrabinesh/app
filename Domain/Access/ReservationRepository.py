...
#             Log::Debug(
#                 'CREDITS - Reservation update adjusting credits for user %s by %s. Required %s, consumed %s',
#                 $reservationSeries->UserId(),
#                 $creditsToDeduct,
#                 $reservationSeries->GetCreditsRequired(),
...
#             $insertAttributeValue = new AddAttributeValueCommand(
...
#             new AddAttributeValueCommand($event->AttributeId(), $event->Value(), $series->SeriesId(), CustomAttributeCategory::RESERVATION),
#             $series
#         );
#     }
...
class DeleteSeriesEventCommand:
    def __init__(self, series):
        self.series = series

    def execute(self, database):
        deleted_by = self.series.BookedBy()
        database.execute(DeleteSeriesCommand(self.series.SeriesId(), Date.now(), deleted_by.UserId if deleted_by else None))

class InstanceRemovedEventCommand:
    def __init__(self, instance, series):
        self.instance = instance
        self.series = series

    def execute(self, database):
        database.execute(RemoveReservationCommand(self.instance.ReferenceNumber()))

# Implement other classes in a similar manner...

class ReservationRepository:
    def add(self, reservation):
        pass

    def load_by_id(self, reservation_instance_id):
        pass

    def load_by_reference_number(self, reference_number):
        pass

    def update(self, existing_reservation_series):
        pass

    def delete(self, existing_reservation_series):
        pass

    def load_reservation_attachment(self, attachment_file_id):
        pass

    def add_reservation_attachment(self, attachment_file):
        pass

    def get_reservation_color_rules(self):
        pass

    def get_reservation_color_rule(self, rule_id):
        pass

    def add_reservation_color_rule(self, color_rule):
        pass

    def delete_reservation_color_rule(self, color_rule):
        pass


class Reservation:
    def __init__(self, reservation_id, reference_number, start_date, end_date):
...
def add_reservation(reservation_id: int, reference_number: str, start_date: str, end_date: str):
    reservation = Reservation(reservation_id, reference_number, start_date, end_date)
