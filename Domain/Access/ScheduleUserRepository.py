...
class ScheduleResource:
    def __init__(self, resourceId, name):
...
class ScheduleGroup:
    def __init__(self, groupId, bookableResources, viewOnlyResources):
        self.groupId = groupId
        self.bookableResources = bookableResources
        self.viewOnlyResources = viewOnlyResources
        self.allResources = bookableResources + viewOnlyResources

    def get_all_resources(self):
        return self.allResources

    def get_bookable_resources(self):
        return self.bookableResources

    def get_view_only_resources(self):
        return self.viewOnlyResources


class ScheduleUser:
    def __init__(
        self, userId, userPermissionsFull, userPermissionsView, groupPermissions, groupAdminPermissions
    ):
        self.userId = userId
        self.userPermissionsFull = userPermissionsFull
        self.userPermissionsView = userPermissionsView
        self.groupPermissions = groupPermissions
        self.adminResources = groupAdminPermissions
    ...
    def get_user_permissions_full(self):
        return self.userPermissionsFull

    def get_user_permissions_view(self):
        return self.userPermissionsView

    def get_admin_resources(self):
        return self.adminResources

    def get_all_resources(self):
        resources = []
        resources.extend(self.get_user_permissions_full())
        resources.extend(self.get_user_permissions_view())
        for group in self.get_group_permissions():
            resources.extend(group.get_all_resources())
        resources.extend(self.get_admin_resources())
    ...
    def get_bookable_resources(self):
        ...
        resources.extend(self.get_user_permissions_full())
        for group in self.get_group_permissions():
            resources.extend(group.get_bookable_resources())
        resources.extend(self.get_admin_resources())
        return list(set(resources))
    ...
    def get_view_only_resources(self):
        ...
        resources.extend(self.get_user_permissions_view())
        for group in self.get_group_permissions():
            resources.extend(group.get_view_only_resources())
        return list(set(resources))
